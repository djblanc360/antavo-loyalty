...
module.exports = {
    getRewards: async function (customer, res) {
        try {
            ...
            console.log(customer.email,'- in retrieve rewards-signed: body is ',customer)
            ...
            console.log(customer.email,'- in customer/rewards-signed.js path: ',path)
            ...
            console.log(customer.email,'- in customer/rewards-signed.js requestOptions: ',requestOptions)
            
            const url = `${api_url}${path}?api_key=${api_key}`
            console.log(customer.email,'- in customer/rewards-signed.js url: ',url)
            
            const response = await fetch(url, requestOptions)

            const data = await response.json()
            console.log(customer.email,'- in customer/rewards-signed.js success: ',data)
